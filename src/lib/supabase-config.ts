// Single source of truth for Supabase connection (Astro Hippo project).
...
export const ASTRO_HIPPO_SUPABASE_URL = "https://eestpryxoabkjfvfqpys.supabase.co";
export const ASTRO_HIPPO_SUPABASE_PUBLISHABLE_KEY =
...
export const ASTRO_HIPPO_SUPABASE_PROJECT_ID = "eestpryxoabkjfvfqpys";
